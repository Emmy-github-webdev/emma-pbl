...
_Useful Terraform Documentation, go through this documentation and understand the arguement needed for each resources:_

<br>

1. [RDS](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/db_subnet_group)
2. [EFS](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/efs_file_system)
3. [KMS](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/kms_key)
...
_Let us create the RDS itself using this snippet of code in **rds.tf** file:_
